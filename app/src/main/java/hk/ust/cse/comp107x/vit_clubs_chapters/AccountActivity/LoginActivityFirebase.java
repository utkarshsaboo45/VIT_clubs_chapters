...
public class LoginActivityFirebase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(LoginActivityFirebase.this, MainActivity.class));
            finish();
        }
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginActivityFirebase.this, ResetPasswordActivityFirebase.class));
            }
        });
                        ...
                        .addOnCompleteListener(LoginActivityFirebase.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(LoginActivityFirebase.this, MainActivity.class);
